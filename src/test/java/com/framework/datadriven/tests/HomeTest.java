...
public class HomeTest extends BaseTest {
	@Test(enabled = true, description = "title test case validation")
	...
	@Test(enabled = true, description = "sign in test case validation")
	...
	@Test(enabled = true, description = "new user sign up test case validation without data provider")
	...
	@Test(enabled = true, dataProvider = "testData", description = "Sign up test case validation with data provider")
